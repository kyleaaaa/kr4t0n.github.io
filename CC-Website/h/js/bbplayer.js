...
(function () {
  ...
  var BBPlayer = function (elem) {
    ...
    this.trackList = [];
	//this.album     = elem.getElemnetsByTagNamr("source").item(0).getAttribute("data-album");
	//this.data-album = elem.getElementsByTagName("source").item(0).getAttribute("data-album");
	//this.data-album = this.bbaudio.getElementsByTagName("source").item(trackNumber).getAttribute("data-album");
    this.init();
  };
  ...
  BBPlayer.prototype.updateDisplay = function () {
	...
	//this.bbplayer.getElemnetsByClassName('bb-artist').item(0).innerHTML = artist;
	//this.bbplayer.getElementsByClassName('bb-album').item(0).innerHTML = album;
  ...
  BBPlayer.prototype.loadTrack = function (trackNumber) {
	...
	//var tempalbum = this.bbaudio.getElementsByTagName("source").item(trackNumber).getAttribute('data-album');
	//this.bbaudio.album = tempalbum;
